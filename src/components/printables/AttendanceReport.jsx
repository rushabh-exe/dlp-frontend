...
function AttendanceReport() {
  ...
  const students = [
    ...
    { rollNo: 9, name: "Sophia Martinez", sign: "", supplement: "", remark: "" },
    { rollNo: 10, name: "William Anderson", sign: "", supplement: "", remark: "" },
    { rollNo: 5, name: "Emily Davis", sign: "", supplement: "", remark: "" },
    { rollNo: 6, name: "Michael Brown", sign: "", supplement: "", remark: "" },
    { rollNo: 7, name: "Olivia Wilson", sign: "", supplement: "", remark: "" },
    { rollNo: 8, name: "James Taylor", sign: "", supplement: "", remark: "" },
  ...
  return (
    <div className="atnreport flex flex-col gap-3 p-5">
            ...
            <tbody>
              {students.map((student, index) => (
                <tr key={index} className="hover:bg-gray-300 transition-all duration-500">
                  <td className="p-2 border border-gray-400 text-center">{student.rollNo}</td>
                  <td className="p-2 border border-gray-400">{student.name}</td>
                  <td className="p-2 border border-gray-400 w-32">{student.sign}</td>
                  <td className="p-2 border border-gray-400">{student.supplement}</td>
                  <td className="p-2 border border-gray-400 w-32">{student.remark}</td>
                </tr>
              ))}
            </tbody>
          </table>
