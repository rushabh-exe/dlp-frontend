              ...
              <div key={studentIndex} className="mb-4">
                ...
                <div className="overflow-y-auto max-h-[500px]">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr>
                        <th className="p-3 border-2 border-black bg-red-400">Roll No</th>
                        <th className="p-3 border-2 border-black bg-red-400">Name</th>
                        <th className="p-3 border-2 border-black bg-red-400">Is Present</th>
                        <th className="p-3 border-2 border-black bg-red-400">Supplement</th>
                      </tr>
                    </thead>
                    <tbody>
                      {studentData.Students &&
                        studentData.Students.map((stud, studIndex) => (
                          <tr key={studIndex}>
                            <td className="p-3 border-2 border-black bg-red-100">{stud.roll_no}</td>
                            <td className="p-3 border-2 border-black bg-red-100">{stud.name}</td>
                            ...
                            <td className="p-3 border-2 border-black bg-red-100">
                              <input
                                ...
                                onChange={(event) => handleSupplementChange(studentIndex, studIndex, event)}
                              />
                            </td>
                          </tr>
                        ))}
